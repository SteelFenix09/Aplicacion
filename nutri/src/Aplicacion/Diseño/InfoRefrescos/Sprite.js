...
import sprite from './../img/Refrescos/Nutri16.png'


function Sprite() {
  return (
    <div><table className="table-striped" >
    <tr><h1 className='Sprite'>Tabla y Recomendaciones</h1></tr>
    <tr>
        
        <td rowSpan={22} className='Pepsi_R'><img src={sprite} id='img-sprite' ></img></td>
