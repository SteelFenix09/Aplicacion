...
function Torci() {
  return (
    ...
    <tr><h1 className='Tocxi'>Tabla y Recomendaciones</h1></tr>
    <tr>
        
        <td rowSpan={22} className='Pepsi_R'><img src={torci} id='img-torci' ></img></td>

            <td colSpan={3}><h4><strong>Informacion Nutricional Por Envase</strong></h4></td>
        <td></td>
