...
function Rufles() {
    ...
    <tr><h1 className='Rufles'>Tabla y Recomendaciones</h1></tr>
    <tr>
        
        <td rowSpan={22} className='Pepsi_R'><img src={rufles} id='img-rufles' ></img></td>

            <td colSpan={3}><h4><strong>Informacion Nutricional Por Envase(60g)</strong></h4></td>
        <td></td>
